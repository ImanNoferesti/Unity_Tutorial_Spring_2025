...
public class Rotation_Helicopter : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.GetChild(2).transform.Rotate(Vector3.up, FanSpeed * Time.deltaTime); // Rotate the child object (fan) at a different speed
